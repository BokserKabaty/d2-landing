$(function () {
  ...
  let countDownDate = new Date("Jun 6, 2020 2:00:00").getTime();
  ...
  let x = setInterval(() => {
    ...
    const days1 = Math.abs(Math.ceil(difference / (1000 * 60 * 60 * 24)));
    ...
    if (difference > 0) {
      ...
      $("#counter").html(`Ladder od: <span class="mx-1 mx-md-3">${days1} dni</span><span class="mr-1 mr-md-3">${hours} godz</span><span class="mr-1 mr-md-3">${minutes} min</span><span>${seconds} sek</span>`);
    }
